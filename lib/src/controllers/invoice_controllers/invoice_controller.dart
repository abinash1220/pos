    ...
    pw.Page(
      build: (pw.Context context) => pw.Center(
        ...
        children: [
          ...
          pw.Container(
            height: 50,
            color:invoiceProtectList.indexOf(value).isEven?  PdfColors.white :PdfColors.grey200,
            child:pw.Row(
              children: [
                //pw.InkWell(
                  // onTap: (){
              ...
              children: [
               pw.Container(
                ...
                child: pw.Center(
                  ...
                  child:pw.Row(
                    mainAxisAlignment: pw.MainAxisAlignment.spaceBetween,
                    children: [pw.Text("Total"),pw.Text(totolamount.toString())])) ),
               ),
            ],),
        ],
        ),
        ...
        children: [
          ...
          pw.Padding(
            ...
            child: pw.Row(
              ...
              children: [
                ...
                pw.Text("3 579,00",textDirection: pw.TextDirection.rtl),
              ]
            ),
          ),
          pw.Padding(
          ...
          pw.Padding(
            ...
            child: pw.Row(
              ...
              children: [
                pw.Text("Total          :"),
                pw.Text("4 080,06",textDirection: pw.TextDirection.rtl),
              ]
            ),
          ),
          pw.Padding(
            ...
            child: pw.Row(
              ...
              children: [
                ...
                pw.Text("6.34  USD",textDirection: pw.TextDirection.rtl),
              ]
            ),
          ),
        ]
