...
class _InvoicePrintingState extends State<InvoicePrinting> {
  ...
  Future _printReceiveTest() async {
    ...
    bytes += generator.text('BEFCO INDUSTRIA,LDA',
        styles: const PosStyles(align: PosAlign.center));
    bytes += generator.text('5000444995',
        styles: const PosStyles(align: PosAlign.center));
    bytes += generator.emptyLines(1);
    bytes += generator.text('Rua IQUA BAIRRO CALEMBA 2',
        styles: const PosStyles(align: PosAlign.left));
    bytes += generator.text('2525      - KILAMBA KIAXI',
        styles: const PosStyles(align: PosAlign.left));
    bytes += generator.text('Tel: 928474747',
        styles: const PosStyles(align: PosAlign.left));
    bytes +=
        generator.text('Fax:', styles: const PosStyles(align: PosAlign.left));
    bytes += generator.emptyLines(1);
    bytes += generator.text('CIF:${invoiceController.invoiceClientId.value}',
        styles: const PosStyles(align: PosAlign.left));
    bytes += generator.text('    ${invoiceController.invoicenome.value}',
        styles: const PosStyles(align: PosAlign.left));
    bytes += generator.text('    ${invoiceController.invoicetaxid.value}',
        styles: const PosStyles(align: PosAlign.left));
    bytes += generator.text('    ${invoiceController.invoicetelephone.value}',
        styles: const PosStyles(align: PosAlign.left));
    bytes += generator.emptyLines(1);
    bytes += generator.text(
        'CDU_MCXID:${invoiceController.multicaxiaTextEditingController.text}',
        styles: const PosStyles(align: PosAlign.left));
    bytes += generator.emptyLines(1);
    bytes += generator.text('Factura ${invoiceController.invoiceSerie}',
        styles: const PosStyles(align: PosAlign.left));
    bytes += generator.text('Factura/Recibo',
        styles: const PosStyles(align: PosAlign.left));
    bytes += generator.text('${dt.day}-${dt.month}-${dt.year}',
        styles: const PosStyles(align: PosAlign.left));
    ...
    for (var value in invoiceController.invoiceProtectList) {
      ...
      bytes += generator.text(
          '${value.qty.toString()} x ${value.unitPrice}  ${value.discount}  ${value.cva}   ${value.totalValue}');
    }
    bytes += generator.hr();
    bytes += generator.text('Cred. Develucoes    :  0.00');
    bytes += generator.text(
        'Total Iliquido      :  ${invoiceController.subtotal.toString()}');
    ...
    bytes += generator.emptyLines(1);
    bytes +=
        generator.text('IVA', styles: const PosStyles(align: PosAlign.center));
    bytes += generator.hr();
    bytes += generator.text('Taxa Incidenia   valor   motivo');
    bytes += generator.text(
        '${invoiceController.iva}  ${invoiceController.subtotal.toString()}   ${invoiceController.totolamount.toString()}  ');
    bytes += generator.emptyLines(1);
    bytes += generator.text(invoiceController.invoicevalue
        .toString()); //bytes += generator.text('n.. 41/AGT/2019 | 0s bens e/ou servicos');
    bytes += generator.emptyLines(1);
    bytes += generator.text('MUITO OBRIGADO',
        styles: const PosStyles(align: PosAlign.center));
